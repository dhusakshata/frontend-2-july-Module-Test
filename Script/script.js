...
function createCard(cityData) {
    ...
    {
        weatherImgString = "images/Big/cloudy.png";
    ...
    {
        weatherImgString = "images/Big/windy.png";
    } 
    if(cityData.weather[0].main == "Rain") 
    {
        weatherImgString = "images/Big/Rainy.png";
    } 
    if(cityData.weather[0].main == "Drizzle") 
    {
        weatherImgString = "images/Big/Tornado.png";
    } 
